...
import { DownloadOutlined, Email, PointOfSale, PersonAdd, Traffic, ContactsOutlined } from '@mui/icons-material'
...
const Dashboard = () => {
  ...
  const isNonMediumScreens = useMediaQuery("(min-width: 1450px)")
